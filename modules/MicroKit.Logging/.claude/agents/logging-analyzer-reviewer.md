---
name: logging-analyzer-reviewer
...
> **Full ID registry:** `.claude-context/standards/logging-event-ids.md`
...
1. Load `.claude/rules/logging-analyzers.md`
2. Load `.claude-context/standards/logging-event-ids.md` for ID assignment
3. Apply checklist
