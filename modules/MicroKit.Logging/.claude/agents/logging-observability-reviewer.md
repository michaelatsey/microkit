...
- [ ] Activity names follow the canonical format from `.claude-context/standards/logging-activity-names.md`
...
- [ ] Event names follow `.claude-context/standards/logging-diagnostics-events.md`
- [ ] Payloads are anonymous objects with documented shape
- [ ] `DiagnosticListener.IsEnabled()` guard before payload construction

## Workflow

1. Load `.claude/rules/opentelemetry.md` and `.claude/rules/logging-diagnostics.md`
2. Load `.claude-context/standards/activity-names.md` and `.claude-context/standards/logging-diagnostics-events.md`
