...
1. Load `.claude/rules/logging-architecture.md` and `.claude/rules/logging-dependencies.md`
2. Load `.claude-context/context/logging-architectural-decisions.md`
3. Load `.claude-context/context/logging-dependency-graph.md`
4. Analyze the request against these constraints
5. If a decision has ecosystem impact, produce an ADR entry for `.claude-context/context/logging-architectural-decisions.md`
