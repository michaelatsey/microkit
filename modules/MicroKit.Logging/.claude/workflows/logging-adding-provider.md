# Workflow: Logging Adding a Provider
...
Run: Use agent logging-dependency-guardian
...
- Update `.claude-context/context/logging-module-responsibilities.md`

### 7. Architecture Review

Run: `/logging-review-architecture --scope <ProviderName>`
