...
Load `.claude-context/templates/enricher-template.md`.
...
Use `/generate-tests <EnricherName>`.
...
Run: `/review-performance --file src/.../Enrichers/<EnricherName>LogEnricher.cs`
