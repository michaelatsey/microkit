...
Check `.claude-context/standards/activity-names.md` or `.claude-context/standards/diagnostics-events.md`.

If the name doesn't exist: add it to the appropriate standards file first.

### 2. Implement

Load `.claude/skills/diagnostics/SKILL.md` for implementation patterns.
...
Run: `/review-observability --scope diagnostics`
