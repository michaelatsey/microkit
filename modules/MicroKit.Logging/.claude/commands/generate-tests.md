...
```
/generate-tests <TargetClass> [--project <TestProjectName>]
```

**Examples:**
```
/generate-tests EnrichmentPipeline
/generate-tests TenantLogEnricher --project UnitTests
/generate-tests CorrelationMiddleware --project IntegrationTests
```
...
2. Load .claude-context/templates/test-template.md
