...
```
/new-generator <GeneratorName>
```

**Examples:**
```
/new-generator LoggerMessageGenerator
/new-generator OperationContextGenerator
```
...
```
1. Load .claude-context/templates/generator-template.md
