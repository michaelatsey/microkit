...
```
/new-analyzer <DiagnosticId> "<Title>"
```

**Examples:**
```
/new-analyzer MKL0011 "Interpolated string used in log message"
/new-analyzer MKL0021 "Non-canonical log property name"
/new-analyzer MKL0031 "Sensitive data in log property name"
```

## What This Command Does

1. Validates the `DiagnosticId` against the registry in `.claude-context/standards/event-ids.md`
...
```
1. Load .claude-context/standards/event-ids.md — validate/assign ID
2. Load .claude-context/templates/analyzer-template.md
...
8. Update .claude-context/standards/event-ids.md with new entry
9. Run: Use agent analyzer-reviewer to validate
```
