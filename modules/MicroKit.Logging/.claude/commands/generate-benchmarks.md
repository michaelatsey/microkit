...
**Examples:**
```
/generate-benchmarks EnrichmentPipeline
/generate-benchmarks OperationContextAccessor
/generate-benchmarks TenantLogEnricher
```
...
- Target from `.claude-context/standards/performance-budget.md` must appear as a comment above each benchmark
