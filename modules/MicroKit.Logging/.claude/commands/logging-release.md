...
```
/logging-release [--version <semver>] [--pre <label>]
```

**Examples:**
```
/logging-release
/logging-release --version 1.2.0
/logging-release --version 1.2.0 --pre beta.1
```

## What This Command Does

Delegates the full release lifecycle to the `logging-release-manager` agent.

## Steps

```
1. Use agent logging-release-manager
