...
All diagnostic IDs are registered in `.claude-context/standards/event-ids.md`.  
**Never assign an ID that is not registered.** Use `/new-analyzer` to get an ID assigned.
