...
These rules govern the structural integrity of MicroKit.Logging. They are enforced by the `architect` agent, `dependency-guardian` agent, and `MicroKit.Logging.ArchitectureTests`.
