...
- Naming format: `MicroKit.[Module].[Operation]` — see `.claude-context/standards/logging-activity-names.md`
...
- Event names follow the standard in `.claude-context/standards/logging-diagnostics-events.md`
