...
See `.claude-context/standards/performance-budget.md` for concrete targets (ns/op, bytes/op).
...
A PR that regresses the allocation budget by more than 10% requires performance-reviewer approval.
