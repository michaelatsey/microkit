...
public sealed class OutboxWorkerTests
{
    ...
    private static OutboxWorker BuildWorker(IOutboxCoordinator coordinator, out IServiceProvider provider)
    {
        var services = new ServiceCollection();
        ...
        return new OutboxWorker(
            provider.GetRequiredService<IServiceScopeFactory>(),
            new OutboxProcessorOptions { PollingInterval = TimeSpan.FromMilliseconds(10) },
            NullLogger<OutboxWorker>.Instance);
    }
