---
description: Prepare and validate a MicroKit.Auth release. Runs the full pre-release checklist and produces git tag commands for the human to execute.
---

Use the microkit-auth-release-manager agent.
