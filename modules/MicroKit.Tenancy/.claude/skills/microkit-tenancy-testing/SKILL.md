...
name: microkit-tenancy-testing
description: Execute, validate, and troubleshoot tests for the MicroKit.Tenancy solution, including unit, integration, and architecture test suites.
---------------------------------------------------------------------------------------------------------------------------------------------------------

# Purpose

Run and validate the MicroKit.Tenancy test suites while ensuring compliance with repository testing standards, architecture rules, and coverage requirements.

## When to Use

Use this skill when:

* Running all tests for MicroKit.Tenancy.
...
```bash
dotnet test modules/MicroKit.Tenancy/MicroKit.Tenancy.slnx -c Release
```
...
```bash
dotnet test modules/MicroKit.Tenancy/tests/MicroKit.Tenancy.IntegrationTests -c Release
```
...
```bash
dotnet test modules/MicroKit.Tenancy/tests/MicroKit.Tenancy.ArchitectureTests -c Release
```
...
```bash
dotnet test modules/MicroKit.Tenancy/MicroKit.Tenancy.slnx \
...
```bash
grep -rn 'FluentAssertions\|\.Should()\.' modules/MicroKit.Tenancy/tests/ --include="*.cs"
```
