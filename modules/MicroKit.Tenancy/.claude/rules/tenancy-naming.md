...
```csharp
namespace MicroKit.Tenancy;                          // Abstractions
namespace MicroKit.Tenancy;                          // Core (same root — no .Core suffix)
namespace MicroKit.Tenancy.AspNetCore;               // ASP.NET Core bridge
namespace MicroKit.Tenancy.EntityFrameworkCore;      // EF Core bridge
namespace MicroKit.Tenancy.Analyzers;                // Roslyn analyzers
```
