# Rule: Analyzers — MicroKit.Tenancy

## Always active for any task touching `MicroKit.Tenancy.Analyzers`.
...
```
src/MicroKit.Tenancy.Analyzers/
├── MicroKit.Tenancy.Analyzers.csproj  ← netstandard2.0; analyzers/dotnet/cs/
├── GlobalUsings.cs
