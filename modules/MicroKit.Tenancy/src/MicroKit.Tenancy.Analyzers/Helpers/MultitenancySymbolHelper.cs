namespace MicroKit.Tenancy.Analyzers.Helpers;

/// <summary>
/// Shared helpers for resolving and comparing MicroKit.Tenancy contract types across analyzers.
...
{
    private const string ITenantEntityName          = "MicroKit.Tenancy.ITenantEntity";
    private const string TenantIdName               = "MicroKit.Tenancy.TenantId";
    private const string ITenantContextAccessorName = "MicroKit.Tenancy.ITenantContextAccessor";
    ...
    /// <c>MicroKit.Tenancy.ITenantEntity</c>.
    /// </summary>
    ...
    /// a non-nullable <c>TenantId</c> property of type <c>MicroKit.Tenancy.TenantId</c>.
    ...
    /// declares a parameter of type <c>MicroKit.Tenancy.ITenantContextAccessor</c>.
    /// </summary>
