...
### 1. Use the multitenancy-implementer agent
```
...
- `.claude/rules/multitenancy-naming.md`
...
- multitenancy-naming.md: {Source}TenantResolutionStrategy convention
- multitenancy-dependencies.md: HTTP-specific strategies stay in AspNetCore package
