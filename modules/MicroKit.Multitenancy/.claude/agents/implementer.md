...
```
□ .claude/rules/architecture.md — contract placement (Abstractions vs Core)
□ .claude/rules/tenant-isolation.md — ITenantEntity, query filter, interceptor
□ .claude/rules/async-context.md — AsyncLocal capture/restore pattern
□ .claude/rules/resolution-pipeline.md — strategy ordering, Result<T> returns
□ .claude/rules/dependencies.md — no forbidden cross-module refs
□ .claude/rules/testing.md — test cases to write
□ .claude/rules/documentation.md — XML docs required on public API
```
