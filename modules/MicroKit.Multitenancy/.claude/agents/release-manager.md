...
description: Use this agent to manage the release lifecycle for MicroKit.Multitenancy. Invoked by /release. Handles CHANGELOG finalization, version validation, tag creation guidance, and NuGet pack verification for all 5 packages.
