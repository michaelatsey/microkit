# Rule: Abstractions Minimality — MicroKit.Multitenancy

## Core principle
`MicroKit.Multitenancy.Abstractions` contains **only what a consuming module needs to compile**.
...
grep -rn 'HttpContext\|IHttpContextAccessor\|Microsoft.AspNetCore' \
  modules/MicroKit.Multitenancy/src/MicroKit.Multitenancy.Abstractions/ --include="*.cs" --include="*.csproj"
...
grep 'PackageReference' \
  modules/MicroKit.Multitenancy/src/MicroKit.Multitenancy.Abstractions/MicroKit.Multitenancy.Abstractions.csproj
```
