...
| Package | Description |
|---------|-------------|
| `MicroKit.Multitenancy.Abstractions` | Contracts: ITenantContext, ITenantStore, TenantId, ITenantEntity |
| `MicroKit.Multitenancy` | Core: AsyncLocal context, resolution pipeline, DI |
| `MicroKit.Multitenancy.AspNetCore` | HTTP middleware + resolution strategies |
| `MicroKit.Multitenancy.EntityFrameworkCore` | EF Core query filters + SaveChanges interceptor |
| `MicroKit.Multitenancy.Analyzers` | Roslyn analyzers: MKT001, MKT002, MKT003 |
