...
public sealed class SealedClassTests
{
    ...
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.TenantResolutionMiddleware)).ShouldBeTrue();
    }

    [Fact]
    public void HeaderTenantResolutionStrategy_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.HeaderTenantResolutionStrategy)).ShouldBeTrue();
    }

    [Fact]
    public void RouteDataTenantResolutionStrategy_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.RouteDataTenantResolutionStrategy)).ShouldBeTrue();
    }

    [Fact]
    public void SubdomainTenantResolutionStrategy_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.SubdomainTenantResolutionStrategy)).ShouldBeTrue();
    }

    [Fact]
    public void ClaimsTenantResolutionStrategy_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.ClaimsTenantResolutionStrategy)).ShouldBeTrue();
    }

    [Fact]
    public void HostTenantResolutionStrategy_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.AspNetCore.HostTenantResolutionStrategy)).ShouldBeTrue();
    }
    ...
    {
        IsSealed(typeof(MicroKit.Multitenancy.EntityFrameworkCore.TenantStampInterceptor)).ShouldBeTrue();
    }

    [Fact]
    public void EfTenantStore_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.EntityFrameworkCore.EfTenantStore)).ShouldBeTrue();
    }

    [Fact]
    public void IgnoreTenantScope_IsSealed()
    {
        IsSealed(typeof(MicroKit.Multitenancy.EntityFrameworkCore.IgnoreTenantScope)).ShouldBeTrue();
    }
}
