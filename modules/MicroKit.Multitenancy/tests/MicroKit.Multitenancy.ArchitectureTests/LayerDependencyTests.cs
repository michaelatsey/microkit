...
public sealed class LayerDependencyTests
{
    ...
    private static readonly Assembly AspNetCoreAssembly =
        typeof(MicroKit.Multitenancy.AspNetCore.TenantResolutionMiddleware).Assembly;

    private static readonly Assembly EfCoreAssembly =
        typeof(MicroKit.Multitenancy.EntityFrameworkCore.TenantStampInterceptor).Assembly;
    ...
    {
        var refs = CoreAssembly.GetReferencedAssemblies();
        refs.Any(a => a.Name == "MicroKit.Multitenancy.AspNetCore").ShouldBeFalse();
    }
    ...
    {
        var refs = CoreAssembly.GetReferencedAssemblies();
        refs.Any(a => a.Name == "MicroKit.Multitenancy.EntityFrameworkCore").ShouldBeFalse();
    }
    ...
    {
        var refs = AspNetCoreAssembly.GetReferencedAssemblies();
        refs.Any(a => a.Name == "MicroKit.Multitenancy").ShouldBeTrue();
    }
    ...
    {
        var refs = CoreAssembly.GetReferencedAssemblies();
        refs.Any(a => a.Name == "MicroKit.Multitenancy.Abstractions").ShouldBeTrue();
    }
}
